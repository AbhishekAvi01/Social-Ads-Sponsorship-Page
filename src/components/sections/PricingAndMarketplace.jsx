// // src/components/sections/PricingAndMarketplace.jsx
// import React, { useState, useMemo } from 'react';
// import { Check, Search, Filter, ShieldCheck, ArrowRight, Coins, Calendar, HelpCircle } from 'lucide-react';
// import { pricingPlans } from '../../data/mockData';
// import { Card } from '../common/Card';
// import { Badge } from '../common/Badge';

// export const PricingAndMarketplace = () => {
//   // Category configuration state management for Marketplace
...
//   // Analytical reactive calculation logic pipeline processing standard filters
...
//         {/* SECTION A: PREMIUM PRICING PLANS */}
...
//                       <span className="text-4xl font-black text-[#111827] tracking-tight">{plan.priceFiat}</span>
//                       <span className="text-xs font-semibold text-[#6B7280]">/ month</span>
//                     </div>
//                     <div className="flex items-center gap-1.5 text-xs text-amber-600 font-medium">
//                       <Coins className="w-3.5 h-3.5" />
//                       <span>Or settle via <span className="font-bold font-mono">{plan.priceCoin} ERC</span></span>
//                     </div>
//                   </div>
...
//                 <button 
//                   className={`mt-8 w-full py-3 px-4 rounded-xl text-xs font-bold transition-all text-center tracking-wide ${
//                     plan.isPopular 
...
//         {/* SECTION B: SPONSOR OPPORTUNITIES MARKETPLACE */}
...
//             {/* Live Complex Search Bar Elements */}
...
//           {/* Dynamic Grid Results Display Container */}
...
//                     </div>
//                     <button className="inline-flex items-center gap-1 text-xs font-bold text-[#111827] group-hover:text-[#dc2626] transition-colors">
...
//             </div>
//           ) : (
//             /* Custom Structural Empty State Vector Element */
...
// export const PricingAndMarketplace = () => {
//   // Category variables for Marketplace
//   const [selectedCategory, setSelectedCategory] = useState('All');
//   const [searchQuery, setSearchQuery] = useState('');

//   // NEW FULLY WORKING APP STATES FOR PRICING CONSOLE
//   const [billingCycle, setBillingCycle] = useState('monthly'); // 'monthly' | 'yearly'
//   const [selectedCheckoutPlan, setSelectedCheckoutPlan] = useState(null); // Active item object
//   const [checkoutCurrency, setCheckoutCurrency] = useState('fiat'); // 'fiat' | 'coin'
...
//   // Action methods to activate checkout sandbox
//   const handleOpenCheckout = (plan) => {
//     setSelectedCheckoutPlan(plan);
//     setCheckoutCurrency('fiat');
...
//     }, 1500); // Simulated delay for blockchain block confirmation
//   };
...
//             {/* DYNAMIC TOGGLE SWITCH FOR MONTHLY vs YEARLY */}
...
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
//             {pricingPlans.map((plan, index) => {
//               // Calculate dynamic discounts for yearly operations
...
//                     }`}
//                   >
//                     {plan.name === 'Enterprise' ? 'Contact Sales Team' : plan.cta}
//                   </button>
//                 </div>
//               );
//             })}
...
//                     </div>
//                     <button 
//                       onClick={() => handleOpenCheckout({ name: opp.title, computedFiat: 'Custom Node', computedCoin: parseInt(opp.cost.replace(',', '')) })}
...
//       {/* ======================================================== */}
//       {/* NEW FULLY WORKING REAL-WORLD CHECKOUT MODAL COMPONENT     */}
//       {/* ======================================================== */}
//       {selectedCheckoutPlan && (
//         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs">
//           <div className="bg-white border border-[#E5E7EB] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative text-left p-6 space-y-6 animate-in fade-in zoom-in-95 duration-150">
...
//                 {/* Currency Switch Toggles inside checkout view */}
//                 <div className="space-y-2">
...
//               </>
//             ) : (
//               /* Transaction Done State Render Widget */
//               <div className="text-center py-6 space-y-4">
//                 <div className="w-12 h-12 bg-emerald-50 text-emerald-600 border border-emerald-200 rounded-full flex items-center justify-center mx-auto text-xl">
//                   <ShieldCheck className="w-6 h-6" />
//                 </div>
//                 <div className="space-y-1">
//                   <h4 className="text-base font-bold text-[#111827]">Ledger Settlement Executed!</h4>
//                   <p className="text-xs text-[#6B7280] max-w-xs mx-auto leading-relaxed">
//                     Transaction hash has been synchronized with the core node. Your network display blocks are now active.
//                   </p>
//                 </div>
//                 <button
//                   onClick={() => setSelectedCheckoutPlan(null)}
//                   className="mt-2 px-5 py-2 bg-[#111827] text-white text-xs font-bold rounded-lg cursor-pointer"
//                 >
//                   Return to Console
//                 </button>
//               </div>
...
export const PricingAndMarketplace = () => {
  ...
  return (
    <section className="py-20 bg-white px-4 sm:px-6 lg:px-8 border-t border-[#E5E7EB]">
      ...
      {/* DYNAMIC SETTLE ALLOCATION LEDGER INTEGRATED CHECKOUT MODAL */}
      {selectedCheckoutPlan && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs">
          <div className="bg-white border border-[#E5E7EB] w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative text-left p-6 space-y-6">
            ...
            {!transactionSuccess ? (
              ...
              /* HIGH-FIDELITY SUCCESS REAL-WORLD TRANSACTION RECEIPT SANDBOX VIEW */
